...
public class AlterarPessoaRegrasTest {
    ...
    public void test_pessoa_with_null_phone_throws_exception() {
        PessoaService service = mock(PessoaService.class);
        AlterarPessoaRegras regras = new AlterarPessoaRegras(service);
        Pessoa pessoa = new Pessoa(1L, "Valid Name", null , null, new Contato(null));
        assertThrows(IllegalArgumentException.class, () -> regras.execute(pessoa));
    }
    ...
    public void test_name_exceeding_maximum_length_should_throw_exception() {
        PessoaService service = mock(PessoaService.class);
        AlterarPessoaRegras regras = new AlterarPessoaRegras(service);
        Pessoa pessoa = new Pessoa(1L, "12345678901", null, null , new Contato("(12) 34567-8910"));
    ...
    public void test_name_with_leading_or_trailing_spaces_should_be_trimmed_and_validated() {
        PessoaService service = mock(PessoaService.class);
        AlterarPessoaRegras regras = spy(new AlterarPessoaRegras(service));
        Pessoa pessoa = new Pessoa(1L, "  ValidName  ", null , null, new Contato("(12) 34567-8910"));
    ...
    public void test_nome_valid_string() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        AlterarPessoaRegras regras = new AlterarPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "ValidName", null , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_nome_special_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        AlterarPessoaRegras regras = new AlterarPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "@Valid#Name!", null , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_nome_mixed_whitespace_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        AlterarPessoaRegras regras = new AlterarPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, " Val id Name ", null , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_nome_non_latin_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        AlterarPessoaRegras regras = new AlterarPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "名字", null , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_nome_numeric_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        AlterarPessoaRegras regras = new AlterarPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "Name123", null , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_very_long_strings_gracefully() {
        ...
        Pessoa pessoa = new Pessoa(1L, longString, null , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_name_length_less_than_10_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        AlterarPessoaRegras regras = new AlterarPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "123456789", null , null, null);
        regras.validarTamanhoNome(pessoa);
    }
    ...
    public void test_name_length_exceeds_10_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        AlterarPessoaRegras regras = new AlterarPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "12345678901", null , null, null);
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            regras.validarTamanhoNome(pessoa);
        });
        assertEquals("O nome não deve ter mais de 10 caracteres", exception.getMessage());
    ...
    public void test_names_with_mixed_case_letters_within_length_limit() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        AlterarPessoaRegras regras = new AlterarPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "AbCdEfGhIj", "igorpcferreira@gmail.com" , null, null);
        regras.validarTamanhoNome(pessoa);
    }
