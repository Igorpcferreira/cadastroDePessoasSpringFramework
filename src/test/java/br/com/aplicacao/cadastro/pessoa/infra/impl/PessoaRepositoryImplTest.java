...
public class PessoaRepositoryImplTest {
    ...
    public void test_consultar_valid_id() {
        ...
        PessoaData pessoaData = new PessoaData(1L, "John Doe", "igorpcferreira@gmail.com" , null, null);
        Pessoa pessoa = new Pessoa(1L, "John Doe", "igorpcferreira@gmail.com" , null, null);
    ...
    public void test_contato_ja_utilizado_true() {
        ...
        Pessoa pessoa = new Pessoa(1L, "John Doe", "igorpcferreira@gmail.com" , null, contato);

        when(pessoaMapper.toData(pessoa)).thenReturn(new PessoaData(1L, "John Doe", "igorpcferreira@gmail.com" , null, new ContatoData(1L, "123456789")));
    ...
    public void test_incluir() {
        ...
        Pessoa pessoa = new Pessoa(null, "John Doe", "igorpcferreira@gmail.com" , null, null);
        PessoaData pessoaData = new PessoaData(null, "John Doe", "igorpcferreira@gmail.com" , null, null);
        PessoaData savedPessoaData = new PessoaData(1L, "John Doe", "igorpcferreira@gmail.com" , null, null);
        Pessoa savedPessoa = new Pessoa(1L, "John Doe", "igorpcferreira@gmail.com" , null, null);
    ...
    public void test_alterar() {
        ...
        Pessoa pessoa = new Pessoa(1L, "John Doe", "igorpcferreira@gmail.com" , null, null);
        PessoaData pessoaData = new PessoaData(1L, "John Doe", "igorpcferreira@gmail.com" , null, null);
        Pessoa updatedPessoa = new Pessoa(1L, "John Doe Updated", "updatedEmail@gmail.com" , null, null);
        PessoaData updatedPessoaData = new PessoaData(1L, "John Doe Updated", "updatedEmail@gmail.com" , null, null);
