...
public class PessoaControllerTest {
    ...
    public void test_consultar_valid_id() {
        ...
        Pessoa pessoa = new Pessoa(1L, "Nome", "igorpcferreira@gmail.com", null, null);
    ...
    public void test_successfully_update_pessoa_with_valid_data() {
        PessoaDto pessoaDto = new PessoaDto(1L, "Valid Name", "igorpcferreira@gmail.com" , new ContatoDto("1234567890"), new EnderecoDto(1L, "bairro"));
        Pessoa pessoa = pessoaDto.toEntity();
    ...
    public void test_update_pessoa_with_name_already_in_use() {
        PessoaDto pessoaDto = new PessoaDto(1L, "Existing Name", "igorpcferreira@gmail.com" , new ContatoDto("1234567890"), new EnderecoDto(1L, "bairro"));
    ...
    public void test_update_pessoa_with_contact_already_in_use() {
        PessoaDto pessoaDto = new PessoaDto(1L, "Valid Name", "igorpcferreira@gmail.com" , new ContatoDto("existing_contact"), new EnderecoDto(1L, "bairro"));
    ...
    public void test_should_return_list_of_pessoa_when_multiple_entries() {
        ...
        List<Pessoa> pessoas = List.of(new Pessoa(1L, "John Doe", "igorpcferreira@gmail.com" , null, null), new Pessoa(2L, "Jane Doe", "igorpcferreira@gmail.com" , null, null));
    ...
    public void test_should_return_http_status_200_on_successful_retrieval() {
        PessoaService pessoaService = mock(PessoaService.class);
        PessoaController pessoaController = new PessoaController(pessoaService, null, null, null);
        Page<Pessoa> page = new PageImpl<>(List.of(new Pessoa(1L, "John Doe", "igorpcferreira@gmail.com" , null, null)));
        when(pessoaService.listar()).thenReturn(page);
        ResponseEntity<List<Pessoa>> response = pessoaController.listar();
        assertEquals(HttpStatus.OK, response.getStatusCode());
    }
