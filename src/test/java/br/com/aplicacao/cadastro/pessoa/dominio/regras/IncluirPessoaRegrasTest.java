...
public class IncluirPessoaRegrasTest {
    ...
    public void test_successfully_alters_valid_pessoa() {
        ...
        Pessoa pessoa = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , null, new Contato("(12) 34567-8910"));
    ...
    public void test_pessoa_with_null_name_throws_exception() {
        PessoaService service = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(service);
        Pessoa pessoa = new Pessoa(1L, null, null , null, new Contato("(12) 34567-8910"));
    ...
    public void test_pessoa_with_long_name_throws_exception() {
        PessoaService service = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(service);
        Pessoa pessoa = new Pessoa(1L, "NameTooLongForValidation", null ,null, new Contato("(12) 34567-8910"));
        assertThrows(IllegalArgumentException.class, () -> regras.execute(pessoa));
    }
    ...
    public void test_pessoa_with_null_phone_throws_exception() {
        PessoaService service = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(service);
        Pessoa pessoa = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com", null, new Contato(null));
        assertThrows(IllegalArgumentException.class, () -> regras.execute(pessoa));
    }
    ...
    public void test_pessoa_with_invalid_phone_format_throws_exception() {
        PessoaService service = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(service);
        Pessoa pessoa = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , null, new Contato("invalidPhone"));
        assertThrows(IllegalArgumentException.class, () -> regras.execute(pessoa));
    }
    ...
    public void test_name_exceeding_maximum_length_should_throw_exception() {
        PessoaService service = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(service);
        Pessoa pessoa = new Pessoa(1L, "12345678901", "igorpcferreira@gmail.com" , null, new Contato("(12) 34567-8910"));
    ...
    public void test_empty_string_as_name_should_throw_exception() {
        PessoaService service = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(service);
        Pessoa pessoa = new Pessoa(1L, "", "igorpcferreira@gmail.com" , null, new Contato("(12) 34567-8910"));
    ...
    public void test_name_with_leading_or_trailing_spaces_should_be_trimmed_and_validated() {
        PessoaService service = mock(PessoaService.class);
        IncluirPessoaRegras regras = spy(new IncluirPessoaRegras(service));
        Pessoa pessoa = new Pessoa(1L, "  ValidName  ", "igorpcferreira@gmail.com" , null, new Contato("(12) 34567-8910"));
    ...
    public void test_nome_null() {
        ...
        Pessoa pessoa = new Pessoa(1L, null, null , null, null);
    ...
    public void test_nome_valid_string() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "ValidName", "igorpcferreira@gmail.com" , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_nome_special_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "@Valid#Name!", "igorpcferreira@gmail.com" , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_nome_mixed_whitespace_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, " Val id Name ", "igorpcferreira@gmail.com" , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_nome_non_latin_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "名字", "igorpcferreira@gmail.com" , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_nome_numeric_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "Name123", "igorpcferreira@gmail.com" , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_exception_message_for_invalid_nome() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "", "igorpcferreira@gmail.com" , null, null);
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            regras.validarNomeNulo(pessoa);
        });
        assertEquals("Nome é obrigatório", exception.getMessage());
    ...
    public void test_very_long_strings_gracefully() {
        ...
        Pessoa pessoa = new Pessoa(1L, longString, "igorpcferreira@gmail.com" , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_nome_escape_sequences() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "Name\nWith\nNewlines", "igorpcferreira@gmail.com" , null, null);
        assertDoesNotThrow(() -> {
            regras.validarNomeNulo(pessoa);
        });
    }
    ...
    public void test_name_length_exactly_10_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "1234567890", "igorpcferreira@gmail.com" , null, null);
    ...
    public void test_name_length_less_than_10_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "123456789", "igorpcferreira@gmail.com" , null, null);
        regras.validarTamanhoNome(pessoa);
    }
    ...
    public void test_name_length_exceeds_10_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "12345678901", "igorpcferreira@gmail.com" , null, null);
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            regras.validarTamanhoNome(pessoa);
        });
        assertEquals("O nome não deve ter mais de 10 caracteres", exception.getMessage());
    ...
    public void test_names_with_numbers_within_length_limit() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "1234567890", null , null, null);
        regras.validarTamanhoNome(pessoa);
    }
    ...
    public void test_names_with_mixed_case_letters_within_length_limit() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "AbCdEfGhIj", null , null, null);
        regras.validarTamanhoNome(pessoa);
    }
    ...
    public void test_name_not_modified_if_within_valid_length() {
        ...
        Pessoa pessoa = new Pessoa(1L, originalName, "igorpcferreira@gmail.com" , null, null);
        regras.validarTamanhoNome(pessoa);
    ...
    public void test_phone_number_is_empty_string() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , null, new Contato(""));
        Exception exception = assertThrows(IllegalArgumentException.class, () -> regras.validarTelefoneContato(pessoa));
        assertEquals("Telefone é obrigatório", exception.getMessage());
    }
    ...
    public void test_phone_number_does_not_match_regex_pattern() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , null, new Contato("123456789"));
        Exception exception = assertThrows(IllegalArgumentException.class, () -> regras.validarTelefoneContato(pessoa));
    ...
    public void test_phone_number_contains_invalid_special_characters() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , null, new Contato("(12) 34567-891@"));
        Exception exception = assertThrows(IllegalArgumentException.class, () -> regras.validarTelefoneContato(pessoa));
        assertEquals("Telefone inválido", exception.getMessage());
    }
    ...
    public void test_phone_number_too_short_or_too_long() {
        ...
        Pessoa pessoaShort = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , null, new Contato("(12) 3456-789"));
        ...
        Pessoa pessoaLong = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , null, new Contato("(12) 34567-89101"));
    ...
    public void test_phone_number_valid_characters_incorrect_format() {
        PessoaService pessoaServiceMock = mock(PessoaService.class);
        IncluirPessoaRegras regras = new IncluirPessoaRegras(pessoaServiceMock);
        Pessoa pessoa = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , null, new Contato("12345678910"));
        Exception exception = assertThrows(IllegalArgumentException.class, () -> regras.validarTelefoneContato(pessoa));
        assertEquals("Telefone inválido", exception.getMessage());
    }
    ...
    public void test_method_does_not_alter_phone_number() {
        ...
        Pessoa pessoa = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , null, new Contato(originalPhoneNumber));
    ...
    public void test_exception_messages_are_clear_and_specific() {
        ...
        Pessoa pessoaNullPhoneNumber = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , null, new Contato(null));
        ...
        Pessoa pessoaInvalidFormatPhoneNumber = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , null, new Contato("123456789"));
    ...
    public void test_method_should_not_modify_the_pessoa_object() {
        ...
        Pessoa pessoa = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , null, contatoOriginal);
    ...
    public void test_method_should_not_have_side_effects_on_other_fields_of_pessoa() {
        ...
        Contato contatoOriginal = new Contato("(12) 34567-8910");
        Pessoa pessoa = new Pessoa(1L, "Valid Name", "igorpcferreira@gmail.com" , enderecoOriginal, contatoOriginal);
